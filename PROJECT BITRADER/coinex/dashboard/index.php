  ...
  <body class=" ">
    ...
    <div id="loading">
      <div class="loader simple-loader">
          <div class="loader-body"></div>    </div>    </div>
    <!-- loader END -->
                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="special-pages/portfolio.html">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="special-pages/academy.html">
                                   <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>                           
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="special-pages/trading.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>                          
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="special-pages/watchlist.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>                          
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="special-pages/list.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>                         
              ...
              <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li class="border-0"><a class="dropdown-item" href="app/user-privacy-setting.html">Privacy Setting</a></li>
                    <li class="border-0"><a class="dropdown-item" href="payments/withdraw-funds.html">Withdraw Funds</a></li>
         ...
         <div class="row align-items-center">
                        ...
                        <div class="d-flex">
                           ...
                           <div class="dropdown mt-2 ms-2">
                              <a href="#" class="text-white" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                 <span class="mt-2">Account Balance</span>
                              ...
                              <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                                 <li><a href="#" class="dropdown-item">Overall Balance</a></li>
                                 <li><a href="#" class="dropdown-item">Total Profit</a></li>
                                 <li><a href="#" class="dropdown-item">Total Deposit</a></li>
                                 <li><a href="#" class="dropdown-item">Total Withdrawal</a></li>
                              </ul>
                           </div> 
                        </div>
                        <div class="d-none d-lg-block w-50">
                           <div class="d-flex justify-content-between align-items-start gap-4">
                              <div class="text-center">
                                 <h5 class="mb-2 text-primary">$0.00</h5>
                                 <p class="mb-0 text-muted">Overall Balance</p>
                              </div>
                              <div class="text-center">
                                 <h5 class="mb-2 text-primary">$0.00</h5>
                              ...
                              <div class="text-center">
                                 <h5 class="mb-2">$0.00</h5>
                                 <p class="mb-0 text-muted">Total Deposit</p>
                              </div>
                              <div class="text-center">
                                 <h5 class="mb-2">$0.00</h5>
            ...
            <div class="col-xl-4">
               <div class="d-grid grid-3-auto gap-card">
                  <a href="payments/payment.html" class="btn btn-primary w-100">
                     + Fund Wallet
                  </a>            
                  <a href="payments/withdraw-funds.html" class="btn btn-primary w-100">
                     Withdraw
                  </a>
                                 </div>
                                 </div>
...
<div class="row pt-2">
            ...
            <div class="row">
                  ...
                  <div class="card shining-card">
                     <div class="card-body">
                        ...
                        <div class="pt-3">
                           ...
                           <div class="pt-3">
                              <small class="text-success">BTC Balance</small>
                           </div>
                        </div>
                     </div>            
                  </div>
                  ...
                  <div class="card shining-card">
                     <div class="card-body">                    
                        ...
                        <div class="progress-detail pt-3">
                           <h4 class="counter" style="visibility: visible;">$0.00</h4>
                           <div class="pt-3">
                              <small class="text-success">DASH Balance</small>
                           </div>
                        </div>
                     </div>            
                  </div>
                     ...
                     <div class="card-body">                    
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                           <div class="d-flex align-items-center gap-2">
                              ...
                              <span class="fs-5 me-2">Ethereum</span>
                              <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M3.86124 21.6224L11.2734 16.8577C11.6095 16.6417 12.041 16.6447 12.3718 16.8655L18.9661 21.2663C19.2968 21.4871 19.7283 21.4901 20.0644 21.2741L27.875 16.2534" stroke="#1aa053" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M26.7847 13.3246L31.6677 14.0197L30.4485 18.7565L26.7847 13.3246ZM30.2822 19.4024C30.2823 19.4023 30.2823 19.4021 30.2824 19.402L30.2822 19.4024ZM31.9991 14.0669L31.9995 14.0669L32.0418 13.7699L31.9995 14.0669C31.9994 14.0669 31.9993 14.0669 31.9991 14.0669Z" fill="#1aa053" stroke="#1aa053"/>
                              </svg>
                        ...
                        <div class="progress-detail pt-3">
                           <h4 class="counter" style="visibility: visible;">$0.00</h4>
                           <div class="pt-3">
                              <small class="text-success">ETH Balance</small>
                           </div>
                        </div>
                     </div>            
                  </div>
               ...
               <div class="col-lg-6">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between flex-wrap gap-3">
                        ...
                        <div class="d-flex">
                           <div class="dropdown p-0">
                              <button class="btn bg-secondary btn-sm dropdown-toggle border-0 text-white" type="button" id="dropdownMenuButton5" data-bs-toggle="dropdown" aria-expanded="false">
                     ...
                     <div class="card-body">
                        <form class="col-lg-12" id="quickTradeForm">
                           <div class="form-group mb-3">
                              <div class="input-group pt-1">
                                 <span class="input-group-text" id="basic-addon3">BTC</span>
                                 <input type="text" class="form-control col-lg-8" placeholder="0,000000" aria-label="BTC amount" id="btcAmount">
                              </div>
                           </div>
                           <div class="form-group mb-3">
                              <div class="input-group pt-2">
                                 <span class="input-group-text" id="basic-addon4">BPL</span>
                                 <input type="text" class="form-control col-lg-8" placeholder="0,000000" aria-label="BPL amount" id="bplAmount">
                              </div>
                           </div>
                           <div class="form-group mb-3">
                              <div class="input-group pt-2">
                                 <span class="input-group-text" id="basic-addon6">Total</span>
                                 <input type="text" class="form-control col-lg-8" placeholder="0,000000" aria-label="Total amount" id="totalAmount">
                              </div>
                           </div>
                           <div class="">
                              <div class="d-grid gap-card grid-cols-2">
                                 <button class="btn btn-success trade-btn" type="button" data-action="buy">
                                    <span>BUY</span>
                                 ...
                                 <button class="btn btn-danger trade-btn" type="button" data-action="sell">
                                    <span>SELL</span>
                        ...
                        <div class="modal fade" id="tradeNotificationModal" tabindex="-1" aria-labelledby="tradeNotificationModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content bg-dark">
                              <div class="modal-header border-bottom border-gray">
                                <h5 class="modal-title text-white" id="tradeNotificationModalLabel">Investment Notice</h5>
                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                     </div>                                          
                              <div class="modal-body">
                                <p class="text-white">Heads up! All trades are handled securely by our expert investment team. Direct trading isn't available at this time. Sit back and let us handle the market for you.</p>
                              </div>
                              <div class="modal-footer border-top border-gray">
               ...
               <div class="col-lg-6">
                  <div class="card">
                     ...
                     <div class="card-body text-left">
                        <div class="row">
                        <div class="col-md-6"> 
                           <div class="card bg-body align-items-start shadow-none mb-lg-0 pt-4 ps-4 pe-4">
                              ...
                              <div class="pt-2">
                                 <h3 class="counter" style="visibility: visible;">$0.00</h3>
                                 <div class="pb-3 pt-3">
                                    <small class="text-muted">No trading activity yet</small>
                                 </div> 
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6"> 
                           <div class="card bg-body align-items-start pt-4 shadow-none mb-0  ps-4 pe-4">
                              <div class="avatar bg-secondary p-2 mb-2">
                                 <svg width="64" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="pt-2">
                                 <h3 class="counter" style="visibility: visible;">$0.00</h3>
                                 <div class="pt-3 pb-3">
                                    <small class="text-muted">Start investing to see insights here</small>
                                 </div>
                              </div>
                           </div>
                        </div>              
                  ...
                  <div class="header-title">
                     ...
                     <div class="d-flex align-items-center">
                           <div class="form-check active">
                              <input class="form-check-input" type="radio" name="cryptoChart" id="btcChart" checked>
                              <label class="form-check-label" for="btcChart">BTC</label>
                        </div>
                     </div>
                     <div class="d-flex align-items-center">
                        <div class="form-check">
                              <input class="form-check-input" type="radio" name="cryptoChart" id="ethChart">
                              <label class="form-check-label" for="ethChart">ETH</label>
                        </div>
                     </div>
                     <div class="d-flex align-items-center">
                        <div class="form-check">
                              <input class="form-check-input" type="radio" name="cryptoChart" id="ltcChart">
                              <label class="form-check-label" for="ltcChart">LTC</label>
                        </div>
                     </div>
                     <div class="d-flex align-items-center">
                        <div class="form-check">
                              <input class="form-check-input" type="radio" name="cryptoChart" id="xmrChart">
                              <label class="form-check-label" for="xmrChart">XMR</label>
                        </div>
                     </div>
                  </div>        
                  </div>
                  <div class="dropdown">
                     <a class="btn btn-primary dropdown-toggle mt-2" href="#" role="button" id="timeframeDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        1H
                     </a>
                     <ul class="dropdown-menu" aria-labelledby="timeframeDropdown">
                        <li><a class="dropdown-item" href="#" data-timeframe="1H">1 Hour</a></li>
                        <li><a class="dropdown-item" href="#" data-timeframe="4H">4 Hours</a></li>
                        <li><a class="dropdown-item" href="#" data-timeframe="1D">1 Day</a></li>
                        <li><a class="dropdown-item" href="#" data-timeframe="1W">1 Week</a></li>
                  </ul>
               </div>
               </div>
               <div class="card-body">
         ...
         <div class="col-lg-12">
            <div class="card card-block card-stretch custom-scroll">
               <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
                  <div class="caption">
                     <h4 class="font-weight-bold mb-2">Recent Transaction Activities</h4>
                  </div>
                  <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                     <input type="checkbox" class="btn-check" id="btncheck1">
                     <label class="btn btn-sm btn-primary active rounded-start" for="btncheck1">Monthly</label>

                     <input type="checkbox" class="btn-check" id="btncheck2">
                     <label class="btn btn-sm btn-primary" for="btncheck2">Weekly</label>

                     <input type="checkbox" class="btn-check" id="btncheck3">
                     <label class="btn btn-sm btn-primary rounded-end" for="btncheck3">Today</label>
                  </div>
               </div>
               <div class="card-body">
   ...
   <div class="col-lg-4">
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <ul class="list-inline m-0 p-0">
                     <li class="pt-3">
                        <div class="d-flex justify-content-between rounded-pill gap-3 flex-wrap flex-md-nowrap">
                           <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                              <img src="assets/images/coins/01.png" class="img-fluid avatar avatar-40 avatar-rounded" alt="img6">
                     ...
                     <li class="pt-3">
                        <div class="d-flex justify-content-between rounded-pill gap-3 flex-wrap flex-md-nowrap">
                           <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                              <img src="assets/images/coins/09.png" class="img-fluid avatar avatar-40 avatar-rounded" alt="img7">
                              <div class="flex-grow-1">
                  ...
                  <div>
                     <button type="button" class="btn btn-primary w-100">
                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M8.74074 8.25926L2 6.7037L16 1M8.74074 8.25926L10.8148 15L16 1M8.74074 8.25926L16 1" stroke="currentColor"/>
                        </svg>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tradeButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                e.preventDefault();
                // Show the modal
                var tradeModal = new bootstrap.Modal(document.getElementById('tradeNotificationModal'));
                tradeModal.show();
            });
        });
    });
    ...
    <script>
    // Initialize the chart with ApexCharts configuration
    let chart;
    ...
    // Initialize chart
    document.addEventListener('DOMContentLoaded', function() {
        chart = new ApexCharts(document.querySelector("#cryptoChart"), chartOptions);
        chart.render();
        ...
        document.querySelectorAll('input[name="cryptoChart"]').forEach(radio => {
            radio.addEventListener('change', function() {
                const symbol = this.id.replace('Chart', '').toUpperCase() + 'USDT';
                switchSymbol(symbol);
            });
        });
        ...
        document.querySelectorAll('[data-timeframe]').forEach(item => {
            item.addEventListener('click', function(e) {
                e.preventDefault();
                currentTimeframe = this.dataset.timeframe.toLowerCase();
                document.getElementById('timeframeDropdown').textContent = this.dataset.timeframe;
                fetchKlines();
            });
        });
    });
    ...
    async function fetchKlines() {
        try {
            const response = await fetch(`https://api.binance.com/api/v3/klines?symbol=${currentSymbol}&interval=${currentTimeframe}&limit=100`);
    ...
    function updateChartRealtime(candle) {
        const series = chart.w.globals.series[0];
        const lastIndex = series.length - 1;
        
        if (series[lastIndex].x === candle.x) {
            // Update last candle
            chart.updateSeries([{
                data: [...series.slice(0, -1), candle]
            }]);
        } else {
            // Add new candle
            chart.appendData([{
    ...
    const mockData = {
        ...
        datasets: [{
            label: 'BTC/USDT',
            data: [45000, 46800, 47500, 48300, 48600, 49300, 49800, 50200],
            borderColor: '#00EC42',
            backgroundColor: 'rgba(0, 236, 66, 0.1)',
            borderWidth: 2,
            fill: true,
            tension: 0.4
        }]
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('input[name="cryptoChart"]').forEach(radio => {
            radio.addEventListener('change', function() {
                ...
                mockData.datasets[0].label = `${symbol}/USDT`;
                chart.update();
            });
        });
    });
