...
<head>
    <meta charset="utf-8">
      ...
      <link href="../../../../fonts.googleapis.com/css2b83f.css?family=Poppins:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,500;1,600;1,700;1,800&amp;display=swap" rel="stylesheet">  </head>
  <body class=" ">
    <!-- loader Start -->
    <div id="loading">
              ...
              <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li class="border-0"><a class="dropdown-item" href="user-profile.html">Profile</a></li>
                    <li class="border-0"><a class="dropdown-item" href="user-privacy-setting.html">Privacy Setting</a></li>
                     ...
                     <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                           ...
                           <div class="d-flex align-items-center mb-3 mb-sm-0">
                              <div>
                                 <h6 class="me-2 text-warning">Full Name</h6>
                                 <p>Job Title</p>
                              </div>
                              <div class="ms-3">
                                 <h6 class="me-2">Email Address</h6>
                                 <p>Email</p>
                              </div> 
                           </div>
                        </div>
                ...
                <div class="col-lg-3">
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="mb-1">Email: <a href="#" class="ms-3">email@example.com</a></div>
                        <div class="mb-1">Phone: <a href="#" class="ms-3">Phone Number</a></div>
                        <div>Location: <span class="ms-3">Location</span></div>
                     </div>
                  </div>
                  <div class="card">
                     <div class="card-header">
                     ...
                     <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                           ...
                           <li class="d-flex mb-4 align-items-center">
                              <img src="../assets/images/coins/04.png" alt="story-img" class="rounded-pill avatar-50  img-fluid">
                              <div class="ms-3">
                                 <h5>Ethereum</h5>
                                 <p class="mb-0">Current Price</p>
                              </div>
                           ...
                           <li class="d-flex align-items-center">
                              <img src="../assets/images/coins/10.png" alt="story-img" class="rounded-pill avatar-50  img-fluid">
                              <div class="ms-3">
                                 <h5>Binance Coin</h5>
                                 <p class="mb-0">Current Price</p>
                              </div>
